...
const CONFIG = {
	...
	WAREHOUSE_STORAGE_KEY: 'STAR_NET_SELECTED_WAREHOUSE', // 收货仓库（Vuex m_user 持久化）

	PURCHASE_CHECKOUT_KEY: 'STAR_NET_PURCHASE_CHECKOUT', // 兼容旧版：勾选行快照（优先使用 pendingId）
	PENDING_PAY_PURCHASES_KEY: 'STAR_NET_PENDING_PAY_PURCHASES', // 本地「待付款」采购草稿列表
	PURCHASE_DONE_IDS_KEY: 'STAR_NET_PURCHASE_DONE_IDS', // 采购成功后要从购物车移除的 product_id 列表
	CHECKOUT_RETURN_SUPPLIER_KEY: 'STAR_NET_CHECKOUT_RETURN_SUPPLIER', // 供应商选择页回传
	CHECKOUT_RETURN_ACCOUNT_KEY: 'STAR_NET_CHECKOUT_RETURN_ACCOUNT', // 结算账户选择页回传
