  ...
  <div>
    ...
    <el-card>
      ...
      <el-row :gutter="20"
        ...
        <el-col :span="8">
          <el-input placeholder="请输入单据编号/供应商编号/供应商名称/备注查询"
...
export default {
  ...
  methods: {
    ...
    // 支出单审核状态改变
    async checkedSwitch (expense) {
      const { data: result } = await this.$http.post('/expense/switchCheck', {
      ...
      expense.checked = result.data.expense.checked
