...
import net.xingluo.erp.rc.command.CDictItemDelete;
import net.xingluo.erp.rc.command.CDictItemDetail;
import net.xingluo.erp.rc.command.CDictItemList;
import net.xingluo.erp.rc.command.CDictItemSave;
