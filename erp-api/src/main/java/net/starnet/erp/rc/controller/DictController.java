...
import net.starnet.erp.rc.command.CDictItemDelete;
import net.starnet.erp.rc.command.CDictItemDetail;
import net.starnet.erp.rc.command.CDictItemList;
import net.starnet.erp.rc.command.CDictItemSave;
